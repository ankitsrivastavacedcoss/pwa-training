...
import defaultClasses from './vendorTile.css';

// TODO: get vendorUrlSuffix from graphql storeOptions when it is ready
const vendorUrlSuffix = '.html';
    ...
    render() {
        ...
        return (
            <Link
                ...
                to={`/${item.url_key}${vendorUrlSuffix}`}
            >
...
export default classify(defaultClasses)(VendorTile);
